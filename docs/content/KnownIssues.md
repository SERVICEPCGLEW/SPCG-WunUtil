...
If `https://servicepcglew-winutil.pages.dev/winutil.ps1` is not working, or you want to download the code from GitHub directly, you can use the direct download link:

```
irm https://github.com/servicepcglew/winutil/releases/latest/download/Winutil.ps1 | iex
```
